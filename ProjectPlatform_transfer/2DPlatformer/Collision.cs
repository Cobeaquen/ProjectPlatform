...
namespace ProjectPlatformer
{
    public static class Collision
    {
        ...
        public static void DebugColliding(Vector2 origin, int width, int height, Color clr)
        {
            int halwid = width / 2;
            int halheight = height / 2;

            int cellR = (int)origin.X + halwid;
            int cellL = (int)origin.X - halwid;
            int cellU = (int)origin.Y - halheight;
            int cellD = (int)origin.Y + halheight;
