...
namespace ProjectPlatformer.Grid
{
    ...
    public class Cell
    {
        ...
        public List<NetworkPlayer> playerEntities = new List<NetworkPlayer>();
        ...
        {
            Vector2 pos = Vector2.Transform(ToVector2(), PlatformerGame.Instance.player.camera.view);
        ...
        {
            grid[cell.x / cellWidth, cell.y / cellHeight] = cell;
        }
        ...
        public static Cell[] GetCellsOnScreen(Vector2 cameraPos, int screenWidth, int screenHeight)
        {
            ...
            for (int y = 0; y < yCells; y++)
            {
                for (int x = 0; x < xCells; x++)
                {
                    ...
                    /*if (entityCells.Contains(cells[arrayIndex]))
                    {
